...
- [📖- ✅ HELLO\_REACT\_FRONT\_END](#---hello_react_front_end)
...
1. Download or clone this [https://github.com/richie1988/Hello_React_Front_End.git).
...
- Clone this [repository](https://github.com/richie1988/Hello_React_Front_End.git) to your desired folder:

- Run this command in your command line interface:

```sh
  cd YOUR_FOLDER
  git clone https://github.com/richie1988/Hello_React_Front_End.git
...
Feel free to check the [issues page](https://github.com/richie1988/Hello_React_Front_End.git/issues).
